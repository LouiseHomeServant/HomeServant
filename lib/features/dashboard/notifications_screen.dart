              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(color: theme.accent.withValues(alpha: 0.18), shape: BoxShape.circle),
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text(item.time, style: AppTextStyles.body(color: theme.onSurface.withValues(alpha: 0.5), size: 11)),
                          ],
                        ),
                        const SizedBox(height: 4),
                        Text(
                          item.body,
                          style: AppTextStyles.body(color: theme.onSurface.withValues(alpha: 0.75), size: 13),
                        ),
                      ],
                    ),
                  ),
