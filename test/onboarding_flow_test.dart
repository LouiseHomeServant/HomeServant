...
void main() {
  testWidgets('Get Started -> Sign Up -> role select -> landlord signup form', (tester) async {
  ...
  testWidgets('Tenant signup -> OTP -> onboarding 1 -> onboarding 2 -> dashboard', (tester) async {
    await tester.pumpWidget(const HomeServantApp());
    await tester.pumpAndSettle();
  ...
  testWidgets('Get Started -> Login -> role select -> landlord login form', (tester) async {
    await tester.pumpWidget(const HomeServantApp());
    await tester.pumpAndSettle();
  ...
  testWidgets('Get Started -> Login -> tenant leads to a tenant login form', (tester) async {
    await tester.pumpWidget(const HomeServantApp());
    await tester.pumpAndSettle();
  ...
  testWidgets('Landlord dashboard: Log Out returns to Get Started', (tester) async {
    await tester.pumpWidget(const HomeServantApp());
    await tester.pumpAndSettle();
  ...
  testWidgets('Tenant dashboard: Log Out returns to Get Started', (tester) async {
    await tester.pumpWidget(const HomeServantApp());
    await tester.pumpAndSettle();
  ...
  testWidgets('Landlord signup -> OTP -> onboarding 1 -> onboarding 2 -> dashboard', (tester) async {
    await tester.pumpWidget(const HomeServantApp());
    await tester.pumpAndSettle();
